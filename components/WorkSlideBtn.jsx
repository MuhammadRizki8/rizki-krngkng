...
const WorkSlideBtn = () => {
  ...
  return (
    <div className="absolute inset-0 xl:bottom-0  items-center xl:right-0 xl:flex xl:justify-end xl:items-end  xl:p-0 z-20 flex justify-between">
      ...
      <button
        className="h-fit bg-blue-700 hover:bg-blue-700 rounded-sm p-4 text-xl text-blue-700 hover:text-slate-300 transition duration-300 xl:absolute xl:left-4 xl:top-1/2 xl:transform xl:-translate-y-1/2"
      ...
      <button
        className="h-fit bg-blue-700 hover:bg-blue-700 rounded-sm p-4 text-xl text-blue-700 hover:text-slate-300 transition duration-300 xl:absolute xl:right-4 xl:top-1/2 xl:transform xl:-translate-y-1/2"
